...
NODE_TYPE_DESCRIPTIONS: dict[str, str] = {
    ...
    "WorkflowRule": "A Salesforce legacy workflow rule metadata definition",
    "WorkflowAction": "A Salesforce legacy workflow action such as a field update",
    ...
    "Report": "A Salesforce report metadata definition",
    "Dashboard": "A Salesforce dashboard metadata definition",
