...
EDGE_TYPES: list[str] = [
    ...
    "FLOW_RESOLVES_LABEL",
    "FLOW_READS_VALUE",
    "VALIDATION_RULE_REFERENCES_FIELD",
    "GRANTS_OBJECT_ACCESS",
    "GRANTS_FIELD_ACCESS",
    "GRANTS_APEX_ACCESS",
    "USES_EXTERNAL_CREDENTIAL",
    # LWC edges (Phase 4)
    "IMPORTS_APEX",
    "WIRES_ADAPTER",
    "CONTAINS_CHILD",
...
NODE_TYPE_DESCRIPTIONS: dict[str, str] = {
    ...
    "AuraComponent": "A Salesforce Aura bundle component or application",
    ...
    "ValidationRule": "A Salesforce object validation rule",
    "PermissionSet": "A Salesforce permission set metadata definition",
    "Profile": "A Salesforce profile metadata definition",
    "NamedCredential": "A Salesforce named credential metadata definition",
