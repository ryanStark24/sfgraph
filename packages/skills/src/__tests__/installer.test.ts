...
describe("skills installer", () => {
  ...
  it("installs to all targets in one call", async () => {
    ...
    expect(claudeCount).toBe(20);
    expect(cursorCount).toBe(20);
    expect(vscodeCount).toBe(20);
